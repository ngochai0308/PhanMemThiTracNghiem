...
namespace DataAccessLayer
{
    ...
    public class DUserAccout
    {
        ...
        {
            DataTable dtData = SqlHelper.ExecuteDataset(strCon, CommandType.StoredProcedure, "UserAccout_select").Tables[0];
            return dtData;
        }
        public static DataTable Search(string Keyword,string roleFilter)
        {
            DataTable dtData = SqlHelper.ExecuteDataset(strCon, CommandType.StoredProcedure, "UserAccout_Search", new SqlParameter("@Keyword", Keyword),new SqlParameter("@roleID", roleFilter)).Tables[0];
            return dtData;
        }
        ...
        public static UserAccout GetUserInfor(string username)
        {
            try
            {
                SqlDataReader reader = SqlHelper.ExecuteReader(strCon, CommandType.StoredProcedure, "UserAccout_GetUserInfor",
