...
namespace DataAccessLayer
{
    ...
    public class DQuestion
    {
        ...
        public static void addNewQuestion(Question newQuestion)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(strCon, "Question_insert"
        ...
        public static void UpdateQuestion(Question editQuestion)
        {
            ...
            {
                SqlHelper.ExecuteNonQuery(strCon, "Question_Update"
        ...
        public static void DeleteQuestion(int QuestionID)
        {
            try
            {
                SqlHelper.ExecuteNonQuery(strCon, "Question_Delete", QuestionID);
            }
            catch (Exception ex)
            {
        ...
        {
            DataTable dtData = SqlHelper.ExecuteDataset(strCon, CommandType.StoredProcedure, "Question_SelectAll").Tables[0];
            return dtData;
        }
        public static DataTable Search(string Keyword)
        {
            DataTable dtData = SqlHelper.ExecuteDataset(strCon, CommandType.StoredProcedure, "Question_search", new SqlParameter("@Keyword", Keyword)).Tables[0];
            return dtData;
        }
        public static DataTable GetQuestionForTest(string subjectID,int numberOfQuestion)
        {
            try
            {
                DataTable dtData = SqlHelper.ExecuteDataset(strCon, CommandType.StoredProcedure, "Question_GetQuestionForTest",
        ...
        public static Question GetOne(int questionID)
        {
            try
            {
                SqlDataReader reader = SqlHelper.ExecuteReader(strCon, CommandType.StoredProcedure, "Question_GetByID",
